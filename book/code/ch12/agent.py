"""
MiniAgent — Chapter 12: 自主智能体
队友现在能主动扫描任务板、认领自己能做的工作，不再需要 Lead 手动分配。
...
def _summarize_input(block) -> str:
    ...
    elif block.name in ("inbox", "team_status", "protocol_list", "scan_tasks"):
        return f"({block.name})"
